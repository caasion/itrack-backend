...
export const composeQueryFromProfile = (profile) => {
    const parts = [
...
export const scoreCandidate = (candidate, signals) => {
    let score = 0;
...
const toProduct = (candidate, source) => ({
    name: candidate.name,
...
const profileAsSignals = (profile) => ({
